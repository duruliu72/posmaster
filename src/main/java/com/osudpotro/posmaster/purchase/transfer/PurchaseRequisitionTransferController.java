...
public class PurchaseRequisitionTransferController {
    ...
    @PostMapping("/{purchaseRequisitionTransferId}/update-from-medicine-corner")
    public PurchaseRequisitionTransferDto updateFromMedicineCorner(@PathVariable Long purchaseRequisitionTransferId, @RequestBody UpdateFromMedicineCornerRequest request) {
        return prtService.updateFromMedicineCorner(purchaseRequisitionTransferId, request);
    }

    @PostMapping("/{purchaseRequisitionTransferId}/update-item-from-medicine-corner/{purchaseRequisitionItemTransferId}")
    public PurchaseRequisitionTransferDto updateItemFromMedicineCorner(@PathVariable Long purchaseRequisitionTransferId, @PathVariable Long purchaseRequisitionItemTransferId, @RequestBody UpdateFromMedicineCornerRequest request) {
        return prtService.updateItemFromMedicineCorner(purchaseRequisitionTransferId, purchaseRequisitionItemTransferId, request);
    }

    @PostMapping("/{purchaseRequisitionTransferId}/add-to-inventory")
    public PurchaseRequisitionTransferDto addToInventory(@PathVariable Long purchaseRequisitionTransferId, @RequestBody AddToInventoryRequest request) {
        return prtService.addToInventory(purchaseRequisitionTransferId, request);
    }
