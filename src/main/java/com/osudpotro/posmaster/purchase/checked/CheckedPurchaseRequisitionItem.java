...
@Setter
@Entity
@Table(name = "checked_purchase_requisition_items", uniqueConstraints = @UniqueConstraint(
        columnNames = {
                "check_purchase_requisition_id",
                "purchase_requisition_item_id",
                "product_id",
                "product_detail_id"
        }
))
public class CheckedPurchaseRequisitionItem {
    @Id
