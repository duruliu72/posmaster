...
import com.osudpotro.posmaster.common.EntitySelfParentException;
...
public class ResourceController {
    ...
    public ResponseEntity<Map<String, String>> handleDuplicateEntity(Exception ex) {
        return ResponseEntity.badRequest().body(
                Map.of("error", ex.getMessage())
        );
    }
    ...
    @ExceptionHandler(EntitySelfParentException.class)
    public ResponseEntity<Map<String, String>> handleEntitySelfParent(Exception ex) {
        return ResponseEntity.badRequest().body(
                Map.of("error", ex.getMessage())
        );
    }
